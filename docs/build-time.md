...
1. **`prefetchCardData()`** in `@repodeckhz/core` fetches many repos
...
```ts
import { prefetchCardData } from '@repodeckhz/core';
...
- [`@repodeckhz/web` reference](./packages/web-component.md) for the
